                        ...
                        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 text-left">
                            <div className="flex gap-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-sm text-gray-600">
                                        <a href="tel:+13109292680" className="font-semibold text-[#F08439] hover:text-[#d97530]">+1 (310) 929 2680</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-sm text-gray-600">
                                        <a href="mailto:info@nemerald.com" className="font-semibold text-[#F08439] hover:text-[#d97530]">info@nemerald.com</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <form action="#" method="POST" className="space-y-6">
                                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="mt-2.5">
                                            <input type="tel" name="phone-number" id="phone-number" autoComplete="tel" required
                                                className="block w-full rounded-xl border-0 px-4 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#F08439] sm:text-sm sm:leading-6 transition-all"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4 mt-6">
                                    <div className="flex gap-x-3">
                                        <div className="flex h-6 items-center">
                                            <input id="privacy" name="privacy" type="checkbox" required className="h-4 w-4 rounded border-gray-300 text-[#F08439] focus:ring-[#F08439]" />
                                        </div>
                                        <label htmlFor="privacy" className="text-sm leading-6 text-gray-600">
                                            I agree to the <Link to="/privacy-policy" className="font-semibold text-[#F08439] hover:underline">processing of personal data</Link>.
                                        </label>
                                    </div>
                                    <div className="flex gap-x-3">
                                        <div className="flex h-6 items-center">
                                            <input id="sms-consent" name="sms-consent" type="checkbox" required className="h-4 w-4 rounded border-gray-300 text-[#F08439] focus:ring-[#F08439]" />
                                        </div>
                                ...
                                <div className="mt-8">
                                    <button type="submit" className="block w-full rounded-full bg-[#F08439] px-3.5 py-4 text-center text-base font-semibold text-white shadow-md hover:bg-[#d97530] hover:shadow-lg transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F08439]">
                                        Send Message
                                    </button>
                                </div>
                            </form>
